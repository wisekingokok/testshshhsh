package com.sherman.getwords.reader.utils;
...
import com.sherman.getwords.reader.PageView;
...
public class ReaderSettingManager {
    ...
    public int getPageMode() {
        return mPreferences.getInt(SHARED_READ_PAGE_MODE, PageView.PAGE_MODE_SLIDE);
    }
    ...
    public int getPageBackground() {
        return mPreferences
                .getInt(SHARED_READ_PAGE_BACKGROUND, ContextCompat.getColor(sContext, R.color.bg_color));
    }
    ...
    public int getTextColor() {
        return mPreferences.getInt(SHARED_READ_TEXT_COLOR, ContextCompat.getColor(sContext, R.color.black));
    }
