...
import com.sherman.getwords.videomanage.utils.DensityUtil;
import com.sherman.getwords.videomanage.utils.ListUtil;
...
//                R.dimen.card_item_margin) * index;
        params.leftMargin = (int) (DensityUtil.getDisplayMetrics(mContext).widthPixels * 0.084);
        params.rightMargin = (int) (DensityUtil.getDisplayMetrics(mContext).widthPixels * 0.084);
